...
def calibration(
    ...
    def on_new_chunk(label, new_chunk) -> None:
        ...
        """
        nonlocal trial_length, data_iti, calib_data, labels  # , asr
        # From uV to V
        # electrode selection
        ...
        # ITI data for rebound and rest starts 0.5s before the end of epoch_duration length and last trial_length
        chunk_iti = new_chunk[
            :,
            :,
        ...
        file_calib = "saved_models\\calib_data.pickle"
        ...
        file_iti = "saved_models\\iti_data.pickle"
        ...
        if len(calib_data) == nb_epochs:
            ...
            save_model(model_name_M2, sample_rate, file_calib, kernels)
